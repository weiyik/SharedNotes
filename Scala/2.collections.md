...
```scala
case class Address(postcode: Option[String], street: String)
case class Customer(name: String, address: Option[Address])
case class Order(customer: Option[Customer])
case class ShippingLabel(name: String, street: String, postCode: String)
...
val l = List(o1, o2)
getShippingLabels(l).foreach(println(_))
---
